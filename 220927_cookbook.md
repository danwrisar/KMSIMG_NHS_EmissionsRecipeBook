...
Along with adding his units (tCO<sub>2</sub>e), Karl added the [SC] tag to support transparency around how this figure was calculated using a reduced data calculation method. The final value added to Stu’s report on emissions associated with natural gas consumption was 25.11tCO<sub>2</sub>e [SC].

E*quation 2.4* A worked example of an SC calculation of emissions associated with consumption of bottled anaesthetic gas.
